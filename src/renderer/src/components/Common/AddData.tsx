  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-2 sm:flex-row sm:items-center">
      ...
      <div className="flex w-full sm:w-auto">
        <Button
          type="submit"
          className="w-full rounded-md border border-blue-600 bg-blue-50 px-3 py-2 text-sm text-blue-700 hover:bg-blue-100 disabled:cursor-not-allowed  cursor-pointer! disabled:opacity-50 sm:w-auto"
